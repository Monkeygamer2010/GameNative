...
JNIEXPORT jint JNICALL
Java_com_winlator_alsaserver_ALSAClient_start(JNIEnv *env, jobject obj, jlong mirrorStreamPtr) {
...
JNIEXPORT void JNICALL
Java_com_winlator_alsaserver_ALSAClient_flush(JNIEnv *env, jobject obj, jlong mirrorStreamPtr) {
    AAudioStream *aaudioStream = (AAudioStream*)mirrorStreamPtr;
...
JNIEXPORT void JNICALL
Java_com_winlator_alsaserver_ALSAClient_pause(JNIEnv *env, jobject obj, jlong mirrorStreamPtr) {
    AAudioStream *aaudioStream = (AAudioStream*)mirrorStreamPtr;
...
JNIEXPORT void JNICALL
Java_com_winlator_alsaserver_ALSAClient_stop(JNIEnv *env, jobject obj, jlong mirrorStreamPtr) {
    AAudioStream *aaudioStream = (AAudioStream*)mirrorStreamPtr;
...
JNIEXPORT void JNICALL
Java_com_winlator_alsaserver_ALSAClient_close(JNIEnv *env, jobject obj, jlong mirrorStreamPtr) {
    AAudioStream *aaudioStream = (AAudioStream*)mirrorStreamPtr;
